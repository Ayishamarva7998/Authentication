...
import 'package:alab_technology/model.dart';
import 'package:alab_technology/otpscreen.dart';
  ...
  Future<UserCredential> signUpWithEmail(
    ...
    try {
      ...
      final UserModel userdata =
          UserModel(email: email, name: name, uid: '', );
  ...
  singinWithGoogle() async {     
    try {
      ...
      final UserModel userdata = UserModel(
          ...
          name: googleuser?.displayName??"", uid: googleuser?.uid??"",
          );
  ...
  void verifyOtp(
   ...
   signInWithGithub(context) async {
    ...
    try {
      ...
      final UserModel userdata = UserModel(
          email: gituser.email, name: gituser.displayName, uid: '', );
